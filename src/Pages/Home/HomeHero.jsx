...
const HomeHero = () => {
  return (
    <div className="-mt-[100px] text-white bg-gradient-to-br from-[#0d0d14] via-[#13131d] to-[#1b1b29]">
      {/* HERO SECTION */}
      <section className="relative h-[calc(100vh+100px)] pt-[80px] px-6 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        <div className="relative z-10 w-full md:w-1/2 text-left pl-4 md:pl-12 lg:pl-20">
          <h1 className="text-6xl md:text-8xl font-extrabold leading-tight mb-4 animate-textGlow">
            Just Say It
          </h1>
          ...
          <Link to="/contact">
            <button className="bg-purple-600 hover:bg-purple-700 px-6 py-3 text-lg font-semibold text-white rounded-xl shadow-lg hover:shadow-purple-500/40 transition-all duration-300">
              Let’s Build Yours →
            </button>
          </Link>
        </div>
